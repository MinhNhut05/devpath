...
export const vi = {
  ...
  onboarding: {
    ...
    loading: 'Đang tải...',
    resumeHeading: 'Chào mừng bạn quay lại',
    resumeBody: 'Bạn đang dở vòng thiết lập ban đầu. Tiếp tục để hoàn thành hồ sơ học tập.',
    resumeCta: 'Tiếp tục',
    stepperLabels: ['Vòng 1', 'Vòng 2', 'Vòng 3'],
    primaryCta: 'Tiếp tục thiết lập',
    roundTwoTitle: 'Định hướng nghề nghiệp',
    roundTwoSubtitle: 'Chia sẻ mục tiêu và phong cách học để chúng tôi cá nhân hóa lộ trình.',
    roundThreeTitle: 'Tự đánh giá kỹ năng',
    roundThreeSubtitle: 'Đánh giá trung thực để chúng tôi gợi ý nội dung phù hợp nhất.',
    confirmCta: 'Xác nhận lộ trình',
    recommendationLoading: 'Đang tạo gợi ý phù hợp cho bạn...',
    confirmError: 'Không thể xác nhận lộ trình lúc này. Hãy thử lại.',
    saveError: 'Không thể lưu tiến độ thiết lập. Hãy kiểm tra kết nối và thử lại.',
    sequentialGateError: 'Bạn cần hoàn thành vòng trước trước khi tiếp tục. Hệ thống sẽ đưa bạn về vòng hiện tại.',
    emptyStateHeading: 'Chưa có câu hỏi cho vòng này',
    emptyStateBody: 'Hiện chưa tải được bộ câu hỏi phù hợp. Hãy thử lại hoặc quay lại sau ít phút.',
    pathNames: {
